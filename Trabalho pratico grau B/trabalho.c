...
Pocao pocoes[] = {
    {"Poção de Cura", {0, 1, 4, 6}, {30, 20, 20, 10}},  // Poção 1
    {"Poção Força da Floresta", {3, 2, 4}, {20, 30, 30}},  // Poção 2
    {"Poção Sabedoria da Riqueza", {1, 0}, {30, 50}},  // Poção 3
    {"Poção Sorte no Amor", {3, 4, 6}, {10, 50, 5}},  // Poção 4
    {"Poção Malvada", {5, 2}, {10, 15}}  // Poção 5
};
...
printf("Digite o número da poção: ");
    scanf("%d", &opcao);
    opcao--;  // Ajusta o índice para o array
